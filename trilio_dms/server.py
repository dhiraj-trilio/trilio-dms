...
class DMSServer:
    ...
    def __init__(self, rabbitmq_url: Optional[str] = None, 
        ...
        ensure_directory(self.mount_base_path)
    ...
    def _handle_mount(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Get mount path from backup_target or construct it
            mount_path = backup_target.get('filesystem_export_mount_path')
            if not mount_path:
                mount_path = get_mount_path(self.mount_base_path, target_id)
    ...
    def _mount_s3(self, request: Dict[str, Any], mount_path: str) -> Dict[str, Any]:
        ...
        try:
            backup_target = request['backup_target']
            keystone_token = request['keystone_token']
            secret_ref = backup_target['secret_ref']
            target_id = backup_target['id']
